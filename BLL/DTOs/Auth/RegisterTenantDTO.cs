...
namespace BLL.DTOs.Auth
{
    public class RegisterTenantDTO
    {
        ...
        [RegularExpression(@"^[a-z0-9-]+$", ErrorMessage = "Subdomain can contain only lowercase letters, numbers, and hyphens.")]
        [StringLength(50,ErrorMessage = "Subdomain cannot exceed 50 characters.")]
        public string Subdomain { get; set; } = string.Empty;
        public PlanType Plan { get; set; } = PlanType.Free;
        public bool IsActive { get; set; } = true;
        public DateTime? TrialEndsAt { get; set; } = DateTime.UtcNow.AddDays(AppConstants.DefaultTrialDays);
